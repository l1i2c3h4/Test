...
namespace Test
{
    ...
    {
        private static string dbProviderName = ConfigurationManager.ConnectionStrings["database"].ProviderName;  //数据提供程序
        private static string dbConnectionString = ConfigurationManager.ConnectionStrings["database"].ConnectionString;  //连接字符串
